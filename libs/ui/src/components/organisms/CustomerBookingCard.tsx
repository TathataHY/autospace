import { BookingsForCustomerQuery } from '@autospace/network/src/generated/graphql'
...
export const CustomerBookingCard = ({ booking }: IBookingCardProps) => {
  const lat = booking.slot.garage.address?.latitude || 0
  const lng = booking.slot.garage.address?.longitude || 0
